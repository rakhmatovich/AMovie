        ...
        <div className='relative'>
            <div className='absolute -top-20 w-full flex justify-center'>
                <form className='p-10 bg-white shadow-xl rounded-xl flex gap-10 items-end'>
                    <label>
                    <span className='block mb-2 font-semibold'>Ckeck date</span>
                        <RangePicker
                            onChange={(values) => {
                    ...
                    <label htmlFor="dults">
                        <span className='block mb-2 font-semibold'>Adults</span>
                    ...
                    <label htmlFor="Children">
                        <span className='block mb-2 font-semibold'>Children</span>
                        <select id="adults" className='border rounded-lg py-1 pl-3 pr-4  outline-yellow-300'>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
